...
---
- - -
**源文档链接和作者:** [linux.do--yeahow](https://linux.do/t/topic/216351)
...
![计算机网络五层结构](https://blogimg.richardli.de/img/20250204121409159.avif)
...
![系统代理工作流程](https://blogimg.richardli.de/img/20250204113327385.avif)
### 1.3 TUN 模式
...
![TUN 模式工作流程](https://blogimg.richardli.de/img/20250204121408394.avif)
...
![DNS 解析过程示意图1](https://blogimg.richardli.de/img/20250204121409457.avif)
...
![TUN 模式 DNS 处理流程](https://blogimg.richardli.de/img/20250204121411439.avif)
...
![redir-host 模式工作流程](https://blogimg.richardli.de/img/20250204113328092.avif)
...
![redir-host 模式域名混淆问题](https://blogimg.richardli.de/img/20250204113328092.avif)
...
![改进后的 redir-host 模式工作流程](https://blogimg.richardli.de/img/20250204122610956.avif)
...
![redir-host 模式 CDN 优选问题](https://blogimg.richardli.de/img/20250204122611222.avif)
...
![fake-ip 模式工作流程](https://blogimg.richardli.de/img/20250204122611222.avif)
...
![方案一 DNS Leak Test 结果](https://blogimg.richardli.de/img/20250204155507517.png)
...
![方案二 DNS Leak Test 结果](https://blogimg.richardli.de/img/20250204122942374.avif)
...
![image-20250204155606910](https://blogimg.richardli.de/img/20250204155607019.png)
...
![组策略编辑器禁用多宿主 DNS 解析](https://blogimg.richardli.de/img/20250204122912603.avif)
...
![Clash Verge Rev 开启严格路由](https://blogimg.richardli.de/img/20250204122912345.avif)
